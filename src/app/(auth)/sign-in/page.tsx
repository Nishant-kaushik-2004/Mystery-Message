...
//   return (
//     <form
//       className="bg-black text-white mx-60 py-28 mt-28 rounded-xl flex items-center gap-10 flex-col"
...
//         Email
//         <input
//           className="bg-pink-100 px-2 py-1 text-black rounded"
//           name="email"
//           type="email"
//         />
//       </label>
...
//         />
//       </label>
//       <button className="bg-green-400 rounded px-6 py-2">Sign In</button>
//     </form>
//   );
// }
